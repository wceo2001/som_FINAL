...
const SECTORS = {
  transfer: {
    ...
    hero: {
      2050: { image: asset("2050s/01.Transfer City/hero/2050_Transfercity_Hero.webp"), video: asset("2050s/01.Transfer City/integrated transfer deck/integrated_transfer_deck_loop.mp4") },
